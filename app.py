...
def get_farmer_by_phone(phoneNumber):
    """Find farmer by Phone (MSISDN) field - handles line break in field name"""
    phoneNumber = phoneNumber.strip()
    print(f"Looking up phone: '{phoneNumber}'")
    
    # Get all farmers and loop through (most reliable way)
        ...
        for record in result['records']:
            ...
            for key in fields.keys():
                if 'Phone' in key or 'MSISDN' in key:
                    ...
                    print(f"Found phone field '{key}' with value: '{phone_value}'")
                    break
